...
async function findAll (req: Request, res: Response): Promise<void> {
  try {
    const licencias = await em.find(
      Licencia,
      {},
      { populate: ['conductor'] }
    )
    res.status(200).json({ message: 'Licencias encontradas: ', data: licencias })
  } catch (error: any) {
...
async function findOne (req: Request, res: Response): Promise<void> {
  try {
    ...
    res.status(200).json({ message: 'Licencia encontrada: ', data: licencia })
  } catch (error: any) {
    res.status(500).json({ message: error.message })
  }
}
...
async function add (req: Request, res: Response): Promise<void> {
  try {
    ...
    await em.flush()
    res.status(201).json({ message: 'Licencia creada', data: licencia })
  } catch (error: any) {
    res.status(500).json({ message: error.message })
  }
}
...
async function update (req: Request, res: Response): Promise<void> {
  try {
    ...
    res
      .status(200)
      .json({ message: 'Licencia actualizada', data: req.body.sanitizedInput })
  } catch (error: any) {
    res.status(500).json({ message: error.message })
  }
}
