...
const em = orm.em;
function sanitizeObservacionInput(req, res, next) {
...
async function findAll(req, res) {
    try {
        const observaciones = await em.find(Observacion, {}, { populate: ['categoriaDenuncia'] });
...
async function findOne(req, res) {
    try {
        ...
        const observacion = await em.findOneOrFail(Observacion, { id }, { populate: ['categoriaDenuncia'] });
